...
class Utility {
  ...
  static setStringListPref(String key, List<String> value)async{
    SharedPreferences mPref = await SharedPreferences.getInstance();
    mPref.setStringList(key, value);
  }

  static setIntPref(String key, int value)async{
    SharedPreferences mPref = await SharedPreferences.getInstance();
    mPref.setInt(key, value);
  }
  ...
  static Future<String> getStringPref(String key)async{
    SharedPreferences mPref = await SharedPreferences.getInstance();
    String? data = mPref.getString(key);
    return data ?? "";
  }

  static Future<List<String>> getStringListPref(String key)async{
    SharedPreferences mPref = await SharedPreferences.getInstance();
    List<String>? data = mPref.getStringList(key);
    return data ?? [];
  }

  static Future<int> getIntPref(String key)async{
    SharedPreferences mPref = await SharedPreferences.getInstance();
    int? data = mPref.getInt(key);
    return data ?? -1;
  }
